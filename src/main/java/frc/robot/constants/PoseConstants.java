...
public class PoseConstants {
    ...
    public static final Pose2d BLUE_LEFT = new Pose2d(1, 5.750, Rotation2d.fromDegrees(0));
    public static final Pose2d BLUE_RIGHT = new Pose2d(1, 2.250, Rotation2d.fromDegrees(0));
    public static final Pose2d RED_LEFT = new Pose2d(15.5, 2.250, Rotation2d.fromDegrees(0));
    public static final Pose2d RED_RIGHT = new Pose2d(15.5, 5.750, Rotation2d.fromDegrees(0));
